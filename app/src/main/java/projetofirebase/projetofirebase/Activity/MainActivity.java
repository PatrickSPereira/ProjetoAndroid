...
public class MainActivity extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnActivityLogin = findViewById(R.id.btnFazerlogin);
    ...
    public void carregarFramentTelaInicial(){
        ...
        fragmentTransaction.add(R.id.frameLayoutTelaInicial, fotosTelaInicialFragment, "FragmentTelaInicial");
